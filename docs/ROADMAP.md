...
| ~~11k~~ | ~~**F146 URL-Based Site Routing**~~ | ~~Done~~ | ~~Shipped 2026-06-01. Proxy-rewrite approach (`/admin/{slug}/...` → cookie-inject + rewrite, URL wins over cookie). Sidebar slug-prefixed via useSiteLink. 18 tests. Live on webhouse.app.~~ |
