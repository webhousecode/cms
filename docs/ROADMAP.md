...
| ~~11m~~ | ~~**F148 Web Application Server (broberg-app)**~~ | ~~Rejected~~ | ~~Multi-tenant Bun-Hono gateway. Afvist 2026-05-09 — blast radius for stor; SPOF for alle customer-webapps. Plan-doc bevares som ref. Erstattet af F149.~~ |
