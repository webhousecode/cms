/* Material Design icon SVG paths for the rich text editor toolbar */
...
export function IconStrikethrough() {
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" width="20" height="20">
      <path d="M6.85 7.08C6.85 4.37 9.45 3 12.24 3c1.64 0 3 .49 3.9 1.28.77.65 1.46 1.73 1.46 3.24h-3.01c0-.31-.05-.59-.15-.85-.29-.86-1.2-1.28-2.25-1.28-1.86 0-2.34 1.02-2.34 1.7 0 .48.25.88.74 1.21.38.26.7.42 1.21.57H7.39c-.29-.3-.54-.64-.54-1.09zM21 12v-2H3v2h9.62c1.15.45 1.96.75 1.96 1.97 0 1-.81 1.67-2.28 1.67-1.56 0-2.54-.74-2.64-2.03h-2.98c.09 1.76 1.03 2.99 2.24 3.53.84.38 1.75.53 2.78.53 1.45 0 2.7-.42 3.57-1.18.87-.76 1.29-1.78 1.29-2.9 0-.58-.11-1.09-.31-1.59H21z" />
    </svg>
  );
}
...
export function IconTable() {
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" width="20" height="20">
      <path d="M20 3H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h15c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm0 2v3H5V5h15zm-9 5h-6v3h6v-3zm0 5h-6v3h6v-3zm2 3v-3h6v3h-6zm6-5h-6v-3h6v3z" />
    </svg>
  );
}
...
export function IconMaximize() {
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" width="16" height="16">
      <path d="M3 3h7v2H5v5H3zm11 0h7v7h-2V5h-5zm-9 14H3v-7h2v5h5v2zm9 0v2h7v-7h-2v5z" />
    </svg>
  );
}
