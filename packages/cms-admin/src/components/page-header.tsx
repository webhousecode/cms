...
export function PageHeader({ children }: Props) {
  ...
  return (
    <header style={{ position: "sticky", top: "var(--cms-chrome-top, 84px)", zIndex: 30, height: "40px", display: "flex", alignItems: "center", borderBottom: "1px solid var(--border)", backgroundColor: "var(--card)" }}>
