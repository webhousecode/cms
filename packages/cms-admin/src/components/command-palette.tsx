...
function buildQuickActions(logout: () => void): QuickAction[] {
  return [
    ...
    { id: "nav-chat", label: "Chat", sublabel: "Chat with your site", category: "navigation", icon: <Terminal style={{ ...ICON_SIZE, color: MUTED }} />, href: "/admin/command", keywords: ["chat", "cockpit", "command", "ai", "spørg"], featured: true },
