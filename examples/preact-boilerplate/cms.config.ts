...
export default defineConfig({
  ...
  collections: [
    defineCollection({
      ...
      kind: "global",
      description:
        "Site-wide configuration: title, meta description, navigation links, footer text. Single record.",
      fields: [
    ...
    defineCollection({
      ...
      kind: "page",
      description:
        'Top-level marketing pages built from blocks. The page with slug "home" becomes the homepage.',
      fields: [
    ...
    defineCollection({
      ...
      kind: "page",
      description:
        "Long-form blog articles. Each post has its own URL under /blog and appears in the RSS feed.",
      fields: [
